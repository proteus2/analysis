...
#YYYY1=1979
#YYYY2=2006
EXTCTL1=3        ### CONTROLLED FOR SPLITTING - 1
EXTCTL2=3        ### CONTROLLED FOR SPLITTING - 2
YYYY1=1979
YYYY2=1979
M1=$EXTCTL1
M2=$EXTCTL2
...
P994=( s VAR_I_NAME  p  u  v  -999 )
P995=( s VAR_I_VERT_GRID  rho )    # rho / theta
P996=( s FILE_ALT  -999 )
P997=( s VAR_ALT  -999 )
#P994=( s VAR_I_NAME  p  theta  dz_dt  -999 )
...
M=$M1        ;  while [ $M    -le $M2    ] ; do
  ...
  P999[2]="$ODIR/${P101[2]}.uv_xypt.$YYYY.${MM}.nc"
