...
M=$M1        ;  while [ $M    -le $M2    ] ; do
  ...
  P999[2]="$ODIR/${P101[2]}.dchm-midlev_pdf.$YYYY.${MM}.nc"
  P998[2]="$ODIR/${P101[2]}.dchm-nonmidlev_pdf.$YYYY.${MM}.nc"
  if [ ! -d $ODIR ] ; then mkdir -p $ODIR ; fi
#  [ -e ${P999[2]} ] && mv ${P999[2]} $ODIR/old.${P101[2]}.dchm-midlev_pdf.$YYYY.${MM}.nc
#  [ -e ${P998[2]} ] && mv ${P998[2]} $ODIR/old.${P101[2]}.dchm-nonmidlev_pdf.$YYYY.${MM}.nc
