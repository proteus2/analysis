...
M=$M1        ;  while [ $M    -le $M2    ] ; do
  ...
  P995[2]="$IDIR2"
  ODIR=/prime0/kyh/dat/L60CGW/epf-wc/$YYYY
  P999[2]="$ODIR/${P101[2]}.epfsa0_koyz.$YYYY.${MM}.nc"
  P1000[2]="$ODIR/${P101[2]}.epf2sa0_koyz.$YYYY.${MM}.nc"
...
#  [ -e ${P1000[2]} ] && mv ${P1000[2]} $ODIR/old.${P101[2]}.epf2_koyz.$YYYY.${MM}.nc
  ...
  cr_nl $F_NAMELIST FILEIO "${P901[*]}" "${P902[*]}" "${P903[*]}" "${P990[*]}" "${P991[*]}" "${P992[*]}" "${P993[*]}" "${P994[*]}" "${P995[*]}" "${P996[*]}" "${P997[*]}" "${P897[*]}" "${P998[*]}" "${P999[*]}" "${P1000[*]}"
  cat $F_NAMELIST
