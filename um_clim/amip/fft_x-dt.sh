...
P104=( n HH  03  8  1 )            # starting time [UTC] and frequency [/day]
P105=( n REFDATE  1941  12  1 )
P106=( n OPT_30D  1 )
#== Parameter 2 ==================================
P201=( s VAR_NAME  dT_conv_nsc_1 )
P202=( s V_INTP  zt )     # set "rho" when interpolating theta to rho levels
...
P994=( s FILE_ALT  "/hippo0/HG2AMIP/L60CGW/invariant/L60_z.nc" )
P995=( s VAR_ALT  ht  ht_1 )  # z_theta, z_rho
P999=( s FILE_O  '' )
#=================================================
P102=( n YYYY  '' )
