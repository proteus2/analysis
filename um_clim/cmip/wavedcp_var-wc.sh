...
P903=( n MISSV  1.e32 )
P991=( s FILE_I_HEAD  "$DATD/AOL60CGW/fcoef_ko" )
P992=( s FILE_I_FORM  XXXX/${P101[2]}.fft_${P201[2]}-wc_ko.XXXX.XXXX.nc  -999 )
...
M=$M1        ;  while [ $M    -le $M2    ] ; do
  ...
  P103[2]=$MM
  ODIR=${P991[2]}/$YYYY
  P999[2]="$ODIR/${P101[2]}.fft_${P201[2]}-wc_wave_ko.$YYYY.${MM}.nc"
