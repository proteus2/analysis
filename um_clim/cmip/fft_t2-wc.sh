...
P991=( s FILE_I_HEAD  '' )
P992=( s FILE_I_FORM  XXXX/${P101[2]}.fft_${P201[2]}-wc_k.XXXX.XXXX.nc  -999 )
...
M=$M1        ;  while [ $M    -le $M2    ] ; do
  ...
  P102[2]=$YYYY0
  P103[2]=$MM0
  IDIR=$DATD/AOL60CGW/fcoef_k
  P991[2]="$IDIR"
  ODIR=$DATD/AOL60CGW/fcoef_ko/$YYYY
  P999[2]="${P201[2]}"
  [ "${P201[3]}" == "-999" ] || P999[2]="${P201[2]}${P201[3]}"
  P999[2]="$ODIR/${P101[2]}.fft_${P999[2]}-wc_ko.$YYYY.${MM}.nc"
