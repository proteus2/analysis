...
P994=( s VAR_I_NAME  p  u  v  theta  dz_dt  -999 )
...
M=$M1        ;  while [ $M    -le $M2    ] ; do
  ...
  P102[2]=$YYYY
  P103[2]=$MM
  ODIR=/prime3/kyh/QBOi_upload/dyn/$expname/$YYYY
  P999[2]="$ODIR/${P101[2]}.qboi-dyn_ypt.$YYYY.${MM}_daily.nc"
  if [ ! -d $ODIR ] ; then mkdir -p $ODIR ; fi
#  [ -e ${P999[2]} ] && mv ${P999[2]} $ODIR/old.${P101[2]}.qboi-dyn_ypt.$YYYY.${MM}_daily.nc
