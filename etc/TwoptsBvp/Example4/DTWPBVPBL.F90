...
!
      ...
      LOGICAL :: bsucc
!
      OPEN(UNIT=26, FILE='batchl.res', STATUS='UNKNOWN')
!
      tols(1) = 1.0D-4
      tols(2) = 1.0D-6
      tols(3) = 1.0D-8
...
!
      ...
      INTEGER(i4) :: iflbvp, i, nmshacc, k, j
! 
...
!
      ...
      INTEGER(i4) :: ltol(NUDIM), iseries(LISERIES)
      INTEGER(i4) :: ipar(1), indnms
...
!     main subroutine
!
      CALL TWPBVPL(ncomp, nlbc, aleft, aright, nfxpnt, fixpnt, ntol,  &
...
! 
      ...
      ENDDO
!
      CALL TWPBVPL(ncomp, nlbc, aleft, aright, nfxpnt, fixpntacc, ntol,  &
