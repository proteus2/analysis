...
!
   ...
   USE CommonRefnum
   USE LMNonFit,     ONLY: LMDER1, ENORM
   USE LMExtern,     ONLY: INITPT, FCN, SSQFCN, SSQJAC
!
   IMPLICIT NONE
!
   REAL(r8) :: fjac(65,40), fnm(60), fvec(65), x(40)
...
!
   DO k = 1, ntries
      ...
      nfev = 0
      njev = 0
      CALL LMDER1(m, n, x, fvec, fjac, tol, info, iwa)
      CALL SSQFCN(m, n, x, fvec, nprob)
      fnorm2 = ENORM(m, fvec)
      np(ic) = nprob
      na(ic) = n
