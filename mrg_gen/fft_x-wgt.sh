...
EXTCTL1=8        ### CONTROLLED FOR SPLITTING - 1
...
#== Parameter 2 ==================================
       #           U  rho
P201=( s VAR_NAME  v  rho )    # The 2nd variable should be at rho levels.
P202=( s V_INTP  -999 )        # -999 / dz_dt
P203=( n K_LARGEST  32 )
P204=( n LAT_RNG  -30.0  30.0 )
P205=( n Z_RNG  15.1  51.0 )
#== Parameter 9 - I/O ============================
...
P990=( s FID  pa  pa )
P991=( s FILE_I_HEAD  "/hippo0/HG2AMIP/L60CGW-t" )
...
M=$M1        ;  while [ $M    -le $M2    ] ; do
  ...
  P102[2]=$YYYY
  P103[2]=$MM
  ODIR=/genie0/kyh/dat/L60CGW-t/fcoef_k/$YYYY
  P999[2]="${P201[2]}"
