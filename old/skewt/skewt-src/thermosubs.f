...
c
     ...
     > z,qv,qs,rh,tv,theta,
     > presLCL,tempLCL,zLCL,presLNB,zLNB,presLFC,zLFC,
...
c
     ...
     >  tvP(n), tvwlP(n), 
     >  dCAPE(maxp)
      Real  zLCL,presLCL, presLNB,zLNB, tempLCL,presLFC,zLFC, 
...
c
     ...
     >  dCAPE,CAPEtvnowl,CINtvnowl,presLNB,zLNB,zLCL,presLFC,zLFC)
c
      Call GetCAPE (n,maxp,ifCB,tv,tvwlP,z,pres,	!Tv(wl)
     >  dCAPE,CAPEtvwl,CINtvwl,presLNB,zLNB,zLCL,presLFC,zLFC)
c
      Call GetCAPE (n,maxp,ifCB,temp,tempP,z,pres,	!T
     >  dCAPE,CAPEt,CINt,presLNB,zLNB,zLCL,presLFC,zLFC)
c
 9901 Format (1x,a,3f8.0)
     ...
     &  CINtvwl, CINtvnowl, CINt
      Print 9901, '% AnalyzSnd2: pLNB (T): ', presLNB*1.e-2
      Print 9901, '% AnalyzSnd2: zLNB (T): ', zLNB
c
      End
c
c
...
c
     ...
     >  capemt,capept, presLNBt,zLNBt,presLFC,zLFC
      Include 'thermo.stfunc'
c
c
c  Input:
...
c
     ...
     >  dcape,capep,capem,presLNB,zLNB,zLCL,presLFC,zLFC)
c
      Call GetCAPE (n,maxp,ifCB,temp,tempP,z,pres,
     >  dcape,capept,capemt,presLNBt,zLNBt,zLCL,presLFC,zLFC)
c
 9901 Format (1x,a,2f8.0)
      Print 9901, '% AnalyzSnd: capep:', capep, capept
      Print 9901, '% AnalyzSnd: capem:', capem, capemt
      Print 9901, '% AnalyzSnd: pLNB:', presLNB*1.e-2
      Print 9901, '% AnalyzSnd: zLNB:', zLNB
c
      End
c
c
