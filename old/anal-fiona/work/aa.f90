program k_spectrum
  ...
  integer, parameter :: nx =1402, nz = 202
  real,    parameter :: dx = 1.e3, dt = 60., dz = 300., zref = 15.e3

  integer, parameter :: nst =   1,    nnd = 240,    ntint = 240
  real,    parameter :: xst =   0.e3, xnd =1200.e3
  real,    parameter :: zst =   0.e3, znd =  60.e3, zint = 10.e3
  ...
  do n=1, ntint
    ...
    open(2,file='/export32/kyh/ing/frcj6/bin/w.bin'//time, &
