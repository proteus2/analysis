...
!--------------------------------------------------------
  ...
  integer, parameter :: nx =1402, nz = 472 , nxp =1200, nzp = 350, ntp = 360
  integer, parameter :: xst = 100, zst = 0, tst = 7200, nzre = 350
  ...
  open(1,file='/usr/users/kyh/anal/work/rhoalloct')
  read(1,*) rhort 
  ...
  do n=1, ntp                              ! time range
    ...
    open(2,file='/export10/kyh/ing/x12oct/bin/w.bin'//time, &
