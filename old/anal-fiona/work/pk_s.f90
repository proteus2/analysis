program k_spectrum
  ...
  real,    parameter :: dx = 1.e3, dt = 60., dz = 300., zref = 60.e3

  integer, parameter :: nst =  61,    nnd = 360,    ntint = 300
  ...
  open(1,file='/usr/users/kyh/arps/work/extfrc/frcj6/rhobar')
  read(1,*) rhobar
  ...
  do n=1, ntint
    ...
    open(2,file='/export32/kyh/ing/105jul/fuwt/fuwt.bin'//time, &
