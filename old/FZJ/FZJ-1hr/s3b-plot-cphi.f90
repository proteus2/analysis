...
!== READ 3D MF SPECTRUM =================================================
    ...
    write(ncfilename,'(a,i0.0,a)') 'res/wind/mf_c_phi/mfx_c_phi_'//speriod//'_f',cf,'.nc'
    ...
    write(ncfilename,'(a,i0.0,a)') 'res/wind/mf_c_phi/mfy_c_phi_'//speriod//'_f',cf,'.nc'
    call opennc(ncfilename, ncid)
    varname='mfy'
...
!== Write Output ========================================================
    ...
    write(ncfilename,'(a,i0.0,a)') 'res/wind/plotdata/mfx_c_phi_plot-data_'//speriod//'_f',cf,'.nc'
    varname='mfx'
    ...
    write(ncfilename,'(a,i0.0,a)') 'res/wind/plotdata/mfy_c_phi_plot-data_'//speriod//'_f',cf,'.nc'
    varname='mfy'
    ...
    write(ncfilename,'(a,i0.0,a)') 'res/wind/plotdata/mf_c_phi_plot-data_'//speriod//'_f',cf,'.nc'
    varname='mf'
