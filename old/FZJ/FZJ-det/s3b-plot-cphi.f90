...
!== Write Output ========================================================
    ...
    write(ncfilename,'(a,i0.0,a)') 'res/temp/plotdata/mfx_c_phi_plot-data_'//speriod//'_f',cf,'.nc'
    varname='mfx'
    ...
    write(ncfilename,'(a,i0.0,a)') 'res/temp/plotdata/mfy_c_phi_plot-data_'//speriod//'_f',cf,'.nc'
    varname='mfy'
    ...
    write(ncfilename,'(a,i0.0,a)') 'res/temp/plotdata/mf_c_phi_plot-data_'//speriod//'_f',cf,'.nc'
    varname='mf'
