...
!== Write Output ========================================================
    ...
    write(ncfilename,'(a,i0.0,a)') 'res/temp2/plotdata/mfx-up_kh_phi_plot-data_'//speriod//'_f',cf,'.nc'
    varname='mfx'
    ...
    write(ncfilename,'(a,i0.0,a)') 'res/temp2/plotdata/mfy-up_kh_phi_plot-data_'//speriod//'_f',cf,'.nc'
    varname='mfy'
    ...
    write(ncfilename,'(a,i0.0,a)') 'res/temp2/plotdata/mf-up_kh_phi_plot-data_'//speriod//'_f',cf,'.nc'
    varname='mf'
