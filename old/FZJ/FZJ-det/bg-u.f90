...
!== READ WRF OUTPUT =====================================================
    ...
    call geta4d_yh(ncid, 'zonal_wind', 5,nxt-8, 5,nyt-8, 1,nz, 1,nt1, u_org)
...
!-- For last file
    ...
    write(ncfilename,'(a,i2.2,a,i2.2,a)') 'new_u_d01_2006-07-',day,'_',hour,':00:00'
    call opennc('/export30/ksy/ewiniar/WRF-0.1mb/0700-0806/new_data/org/u_wind/'//ncfilename, ncid)
    call geta4d_yh(ncid, 'zonal_wind', 5,nxt-8, 5,nyt-8, 1,nz, 1,1, u_org)
    call closenc(ncid)
...
!== Write Output ========================================================
    ...
    ncfilename='res/u_background_'//speriod//'.nc'
    call out4d(ncfilename, 'ub', ub4d, &
               'x_km', nx, x, &
               'y_km', ny, y, &
               'height_m', nz, z, &
               'time_min', nt, time, &
