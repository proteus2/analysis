    ...
    real, dimension(nx, ny, nz, nt, 2) :: var
...
!== Background wind (21x21 running mean) ==============================
    ...
    call opennc('res/t_background_'//speriod//'.nc', ncid)
...
!== Write Output ========================================================
    ...
    write(ncfilename,'(a,i0.0,a)') 'res/temp2/field/tp_'//speriod//'_f',cf,'-e1.nc'
    call out4d_yh(ncfilename, 2, (/'t_up','t_dn'/), &
               var, &
               'west_east' , nx, x, &
               'sout_north', ny, y, &
               'height'    , nz, z, &
