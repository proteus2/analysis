...
!== Divide cospectra to bins (phase speed, propagation direction)
    ...
    do k=1, nz
      ...
      do i=1, nx
        ...
        kh=sqrt( freq_x(i)*freq_x(i) + freq_y(j)*freq_y(j) )
...
!== Write Output ========================================================
    ...
    write(ncfilename,'(a,i0.0,a)') 'res/temp2/mf_kh/mfx_kh_'//speriod//'_f',cf,'.nc'
    ...
    write(ncfilename,'(a,i0.0,a)') 'res/temp2/mf_kh/mfy_kh_'//speriod//'_f',cf,'.nc'
    call out2d_yh(ncfilename, 9, &
               (/'mfy     ','mfy_n   ','mfy_s   ',   &
