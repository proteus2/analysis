...
PROGRAM analysis_UM
  ...
  integer, parameter ::  dstart = 11, dend = 31
  integer, parameter ::  nutc  =  2, ustart = 0
  real,    parameter ::  fstart = 0.0, fend = 0.0, fitv = 0.5   ! [day]
  integer, parameter ::  nvar = 4
  real,    parameter ::  missv = 1.e32
  integer, parameter ::  nexcept = 18
  ...
  ! exceptions
  data                   excdate(1)  /'2010011300'/
  data                   excdate(2)  /'2010011312'/
  data                   excdate(3)  /'2010011400'/
  data                   excdate(4)  /'2010011412'/
  data                   excdate(5)  /'2010011500'/
  data                   excdate(6)  /'2010011512'/
  data                   excdate(7)  /'2010011600'/
  data                   excdate(8)  /'2010011612'/
  data                   excdate(9)  /'2010011700'/
  data                   excdate(10) /'2010011712'/
  data                   excdate(11) /'2010011800'/
  data                   excdate(12) /'2010011812'/
  data                   excdate(13) /'2010011900'/
  data                   excdate(14) /'2010011912'/
  data                   excdate(15) /'2010012000'/
  data                   excdate(16) /'2010012012'/
  data                   excdate(17) /'2010012100'/
  data                   excdate(18) /'2010012112'/
!  data                   excdate(19) /'2010012200'/
!  data                   excdate(20) /'2010012212'/
!  data                   excdate(21) /'2010012300'/
!  data                   excdate(22) /'2010012312'/
!  data                   excdate(23) /'2010012400'/
!  data                   excdate(24) /'2010012412'/
!  data                   excdate(25) /'2010012500'/
!  data                   excdate(26) /'2010012512'/
!  data                   excdate(27) /'2010012600'/
!  data                   excdate(28) /'2010012612'/
!  data                   excdate(29) /'2010012700'/
!  data                   excdate(30) /'2010012712'/
!  data                   excdate(31) /'2010012800'/
!  data                   excdate(32) /'2010012812'/
!  data                   excdate(33) /'2010012900'/
!  data                   excdate(34) /'2010012912'/
!  data                   excdate(35) /'2010013000'/
!  data                   excdate(36) /'2010013012'/
!  data                   excdate(37) /'2010013100'/
!  data                   excdate(38) /'2010013112'/
  ! files
...
!  call fct0_time(year,month,date,utc,fct, year0,month0,date0,utc0)
  ...
  if ( tag ) then
    write(6,*) ' Exception '
    fname = trim(ifdir)//trim(expname)//'2/'//cmonth0//'/'//cutc0//'/'// &
            cutc0//'.'//trim(vartype)//'.nc'
  end if
