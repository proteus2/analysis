...
PROGRAM TEM
  ...
  ! output variables
  data  vname_o(1 ) /'v_res'/
  data  vname_o(2 ) /'w_res'/
  data  vname_o(3 ) /'u_force'/
  data  vname_o(4 ) /'t_force'/
  data  vname_o(5 ) /'cor'/
  data  vname_o(6 ) /'uadv_y'/
  data  vname_o(7 ) /'uadv_z'/
  data  vname_o(8 ) /'epd'/
  data  vname_o(9 ) /'f_y'/
  data  vname_o(10) /'f_z'/
  data  vname_o(11) /'tadv_y'/
  data  vname_o(12) /'tadv_z'/
  data  vname_o(13) /'t_eddy'/
  data  vname_o(14) /'u_tend'/
  data  vname_o(15) /'t_tend'/
