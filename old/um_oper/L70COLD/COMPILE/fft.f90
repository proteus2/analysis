...
!----------------------------------------------------------------------------------
    ...
    public :: fft1df,fft1db, fft1dcf, fft1dcb
    public :: fft2df,fft2db, fft2dcf, fft2dcb
    public :: rearr_coef1d 
    public :: rearr_coef2d
...
!----------------------------------------------------------------------------------
    ...
    subroutine fft1dcf(nx    ,data  ,coef  )
    
    implicit none
    
    integer                            ,intent(in)  :: nx
    complex         ,dimension(nx)     ,intent(in)  :: data
    double complex  ,dimension(nx)     ,intent(out) :: coef
...
!----------------------------------------------------------------------------------
    ...
    subroutine fft1dcb(nx    ,coef  ,data  )

    implicit none

    integer                        ,intent(in)  :: nx
    double complex  ,dimension(nx) ,intent(in)  :: coef
    complex         ,dimension(nx) ,intent(out) :: data
    ...
    do i=1,nx
      data(i) = (1./float(nx))*cmplx(coef(i))
    end do

    return
    end subroutine fft1dcb
...
!----------------------------------------------------------------------------------
    ...
    subroutine fft2dcf(nx    ,ny    ,data  ,coef)

    implicit none

    integer                            ,intent(in)  :: nx     ,ny
    complex         ,dimension(nx,ny)  ,intent(in)  :: data
    double complex  ,dimension(nx,ny)  ,intent(out) :: coef
...
!----------------------------------------------------------------------------------
    ...
    subroutine fft2dcb(nx    ,ny    ,coef  ,data  )

    implicit none

    integer                            ,intent(in)  :: nx     ,ny
    double complex  ,dimension(nx,ny)  ,intent(in)  :: coef
    complex         ,dimension(nx,ny)  ,intent(out) :: data
    ...
    do i=1,nx
      do j=1,ny
        data(i,j) = 1./(float(nx)*float(ny))*cmplx(coef2(i,j))
      end do
    end do

    return
    end subroutine fft2dcb
