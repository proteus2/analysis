...
P05=( n FCT  0.0  5.0 )          # forecast time
...
P00=( s FILE_I "" '/data10/kyh/ERAinter' )
P99=( s FILE_O "" )

F_SOURCE='op-zme2-era'
F_NAMELIST='namelist/namel.sc_ra-'$$
F_LOG='log/log.score-ra-'$$
...
P99[2]="$FILE_HEAD/$exp/anal/$exp.zme2-era.$mon.nc"
