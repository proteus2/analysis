...
P06=( n T_INTG  1.0 )             # integral interval
P08=( s EXCEPTION  2009070000 )   # YYYYMMDDTT
P09=( n ITVY  4 )                 # sampling # for latitudes

FILE_HEAD='/data1/kyh/portal/UM_OPER'
P00=( s FILE_I "" )
P99=( s FILE_O "" )

F_SOURCE='op-tema-ysel_ypft'
F_NAMELIST='namelist/namelist.tem-'$$
F_LOG='log/log.tem-'$$
...
cr_nl $F_NAMELIST PARAM "${P03[*]}" "${P04[*]}" "${P06[*]}" "${P08[*]}" "${P09[*]}"

P00[2]="$FILE_HEAD/L50CYCLE/$exp/$mon"
P99[2]="$FILE_HEAD/anal/L50CYCLE/$exp/tmp/$exp.tema-ysel_ypft.$mon.nc"
