...
!------------------------------------------------------------------------------
    ...
    integer :: oroid ,latid ,tid   ,fctid ,zid   ,zuid  ,ztid  
    ...
    istat = nf_inq_varid(ncid2,'fcst'  ,fctid)
    ...
    istat = nf_get_var_real(ncid2,fctid,fct  )
...
!-----------------------------------------------------------------------
    ...
    integer :: istat ,ncid
    integer :: latdid,zdid  ,fctdid
    integer :: latid ,zid   ,fctid
    ...
    write(wfn1,'(A)') '/data8/kyh/UM_OPER/anal/L50CYCLE/GWDC/pp/gwdc.circ_ypf.201001.nc'

    istat = nf_create(trim(wfn1),nf_clobber,ncid)
    istat = nf_def_dim(ncid,'lat',nny,latdid)
    istat = nf_def_dim(ncid,'z'  ,nnz,zdid  )
    istat = nf_def_dim(ncid,'fct',nt ,fctdid)
    istat = nf_def_var(ncid,'lat'    ,nf_real,1,latdid,latid)
    istat = nf_def_var(ncid,'z'      ,nf_real,1,zdid  ,zid  )
    istat = nf_def_var(ncid,'fct'    ,nf_real,1,fctdid,fctid)
    istat = nf_def_var(ncid,'epd'    ,nf_real,3,(/latdid,zdid,fctdid/),epdid1)
    istat = nf_def_var(ncid,'gwd'    ,nf_real,3,(/latdid,zdid,fctdid/),gwdid1)
    istat = nf_def_var(ncid,'gwo'    ,nf_real,3,(/latdid,zdid,fctdid/),gwoid1)
    istat = nf_def_var(ncid,'chiepd' ,nf_real,3,(/latdid,zdid,fctdid/),chiid1)
    istat = nf_def_var(ncid,'chigwd' ,nf_real,3,(/latdid,zdid,fctdid/),chiid2)
    istat = nf_def_var(ncid,'chigwo' ,nf_real,3,(/latdid,zdid,fctdid/),chiid3)
    istat = nf_def_var(ncid,'vsepd'  ,nf_real,3,(/latdid,zdid,fctdid/),vsid1)
    istat = nf_def_var(ncid,'vsgwd'  ,nf_real,3,(/latdid,zdid,fctdid/),vsid2)
    istat = nf_def_var(ncid,'vsgwo'  ,nf_real,3,(/latdid,zdid,fctdid/),vsid3)
    istat = nf_def_var(ncid,'wsepd'  ,nf_real,3,(/latdid,zdid,fctdid/),wsid1)
    istat = nf_def_var(ncid,'wsgwd'  ,nf_real,3,(/latdid,zdid,fctdid/),wsid2)
    istat = nf_def_var(ncid,'wsgwo'  ,nf_real,3,(/latdid,zdid,fctdid/),wsid3)
    istat = nf_def_var(ncid,'dtvepd' ,nf_real,3,(/latdid,zdid,fctdid/),dtvid1)
    istat = nf_def_var(ncid,'dtvgwd' ,nf_real,3,(/latdid,zdid,fctdid/),dtvid2)
    istat = nf_def_var(ncid,'dtvgwo' ,nf_real,3,(/latdid,zdid,fctdid/),dtvid3)
    istat = nf_def_var(ncid,'dtwepd' ,nf_real,3,(/latdid,zdid,fctdid/),dtwid1)
    istat = nf_def_var(ncid,'dtwgwd' ,nf_real,3,(/latdid,zdid,fctdid/),dtwid2)
    istat = nf_def_var(ncid,'dtwgwo' ,nf_real,3,(/latdid,zdid,fctdid/),dtwid3)
    ...
    istat = nf_def_var(ncid,'gwc'   ,nf_real,3,(/latdid,zdid,fctdid/),gwcid1)
    istat = nf_def_var(ncid,'chigwc' ,nf_real,3,(/latdid,zdid,fctdid/),chiid4)
    istat = nf_def_var(ncid,'vsgwc'  ,nf_real,3,(/latdid,zdid,fctdid/),vsid4)
    istat = nf_def_var(ncid,'wsgwc'  ,nf_real,3,(/latdid,zdid,fctdid/),wsid4)
    istat = nf_def_var(ncid,'dtvgwc' ,nf_real,3,(/latdid,zdid,fctdid/),dtvid4)
    istat = nf_def_var(ncid,'dtwgwc' ,nf_real,3,(/latdid,zdid,fctdid/),dtwid4)
    ...
    istat = nf_put_var_real(ncid,fctid ,fct)
