...
PROGRAM analysis_UM
  ...
  ! exceptions
  data                   excdate(1 ) /'2010012500'/
  data                   excdate(2 ) /'2010012512'/
!  data                   excdate(3 ) /'2010012600'/
!  data                   excdate(4 ) /'2010012612'/
!  data                   excdate(5 ) /'2010012700'/
!  data                   excdate(6 ) /'2010012712'/
!  data                   excdate(7 ) /'2010012800'/
!  data                   excdate(8 ) /'2010012812'/
!  data                   excdate(9 ) /'2010012900'/
!  data                   excdate(10) /'2010012912'/
!  data                   excdate(11) /'2010013000'/
!  data                   excdate(12) /'2010013012'/
!  data                   excdate(13) /'2010013100'/
!  data                   excdate(14) /'2010013112'/
  ! files
