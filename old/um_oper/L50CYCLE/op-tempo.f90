...
PROGRAM analysis_UM
  ...
  integer, parameter ::  dstart = 1, dend = 3  ! 1, 31
  integer, parameter ::  nutc  =  2, ustart = 0  ! 2, 0
  real,    parameter ::  fstart = 0.0, fend = 5.0, fitv = 0.5   ! [day]
  integer, parameter ::  nvar = 4
  real,    parameter ::  missv = 1.e32
  integer, parameter ::  nexcept = 5
  ...
  data                   excdate(2) /'0010010112'/
  data                   excdate(3) /'0009070100'/
  data                   excdate(4) /'2009070112'/
  data                   excdate(5) /'2009070312'/
  ! files
