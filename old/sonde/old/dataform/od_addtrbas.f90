!23456
      ...
      do i=1,nday
        ...
        write(fnamet, '(a,i6.6,a)')  &
                      '/export9/radiosonde/rusa/osan24_500/T/ttrbas', date(i), '.nc'
        write(fnameu, '(a,i6.6,a)')  &
                      '/export9/radiosonde/rusa/osan24_500/U/utrbas', date(i), '.nc'
        write(fnamev, '(a,i6.6,a)')  &
                      '/export9/radiosonde/rusa/osan24_500/V/vtrbas', date(i), '.nc'
        write(fnamebv, '(a,i6.6,a)')  &
                        '/export9/radiosonde/rusa/osan24_500/BV/bvtrbas', date(i), '.nc'
        write(fnamer, '(a,i6.6,a)')  &
                        '/export9/radiosonde/rusa/osan24_500/RHO/rtrbas', date(i), '.nc'
      ...
      write(wfname, '(a)')  '/export9/radiosonde/rusa/osan24_500/add_data/tr/ttrbasmaxabs.nc'
      call out1d(trim(wfname), 'TBASMAX', tbasmax, 'TIME', nday, day, trim(title))
    
      write(title,  '(a)')  'TBASMIN'
      write(wfname, '(a)')  '/export9/radiosonde/rusa/osan24_500/add_data/tr/ttrbasminabs.nc'
      call out1d(trim(wfname), 'TBASMIN', tbasmin, 'TIME', nday, day, trim(title))

      write(title,  '(a)')  'UBASMAX'
      write(wfname, '(a)')  '/export9/radiosonde/rusa/osan24_500/add_data/tr/utrbasmaxabs.nc'
      call out1d(trim(wfname), 'UBASMAX', ubasmax, 'TIME', nday, day, trim(title))
    
      write(title,  '(a)')  'UBASMIN'
      write(wfname, '(a)')  '/export9/radiosonde/rusa/osan24_500/add_data/tr/utrbasminabs.nc'
      call out1d(trim(wfname), 'UBASMIN', ubasmin, 'TIME', nday, day, trim(title))
    
      write(title,  '(a)')  'VBASMAX'
      write(wfname, '(a)')  '/export9/radiosonde/rusa/osan24_500/add_data/tr/vtrbasmaxabs.nc'
      call out1d(trim(wfname), 'VBASMAX', vbasmax, 'TIME', nday, day, trim(title))
    
      write(title,  '(a)')  'VBASMIN'
      write(wfname, '(a)')  '/export9/radiosonde/rusa/osan24_500/add_data/tr/vtrbasminabs.nc'
      call out1d(trim(wfname), 'VBASMIN', vbasmin, 'TIME', nday, day, trim(title))

      write(title,  '(a)')  'BVBASMAX'
      write(wfname, '(a)')  '/export9/radiosonde/rusa/osan24_500/add_data/tr/bvtrbasmaxabs.nc'
      call out1d(trim(wfname), 'BVBASMAX', bvbasmax, 'TIME', nday, day, trim(title))
    
      write(title,  '(a)')  'BVBASMIN'
      write(wfname, '(a)')  '/export9/radiosonde/rusa/osan24_500/add_data/tr/bvtrbasminabs.nc'
      call out1d(trim(wfname), 'BVBASMIN', bvbasmin, 'TIME', nday, day, trim(title))


      write(title,  '(a)')  'all TBAS'
      write(wfname, '(a)')  '/export9/radiosonde/rusa/osan24_500/add_data/tr/ttrbas0208.nc'
      call out2d(trim(wfname), 'TBAS', allt, 'TIME', nday, day,   &
                                'Z', nlev, Z, trim(title)              )
 
      write(title,  '(a)')  'all UBAS'
      write(wfname, '(a)')  '/export9/radiosonde/rusa/osan24_500/add_data/tr/utrbas0208.nc'
      call out2d(trim(wfname), 'UBAS', allu, 'TIME', nday, day,   &
                                'Z', nlev, Z, trim(title)              )

      write(title,  '(a)')  'all VBAS'
      write(wfname, '(a)')  '/export9/radiosonde/rusa/osan24_500/add_data/tr/vtrbas0208.nc'
      call out2d(trim(wfname), 'VBAS', allv, 'TIME', nday, day,   &
                                'Z', nlev, Z, trim(title)              )

      write(title,  '(a)')  'all BVBAS'
      write(wfname, '(a)')  '/export9/radiosonde/rusa/osan24_500/add_data/tr/bvtrbas0208.nc'
      call out2d(trim(wfname), 'BVBAS', allbv, 'TIME', nday, day,   &
                                'Z', nlev, Z, trim(title)              )

      write(title,  '(a)')  'all RHOBAS'
      write(wfname, '(a)')  '/export9/radiosonde/rusa/osan24_500/add_data/tr/rtrbas0208.nc'
