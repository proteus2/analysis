!23456
      ...
      do i=1,nday
        ...
        write(fnamet, '(a,i6.6,a)')  &
                      '/export9/radiosonde/rusa/osan24_500/T/tstprt', date(i), '.nc'
        write(fnameu, '(a,i6.6,a)')  &
                      '/export9/radiosonde/rusa/osan24_500/U/ustprt', date(i), '.nc'
        write(fnamev, '(a,i6.6,a)')  &
                      '/export9/radiosonde/rusa/osan24_500/V/vstprt', date(i), '.nc'
      ...
      write(wfname, '(a)')  '/export9/radiosonde/rusa/osan24_500/add_data/st/tstprtmaxabs.nc'
      call out1d(trim(wfname), 'TPRTMAX', tprtmax, 'TIME', nday, day, trim(title))
    
      write(title,  '(a)')  'TPRTMIN'
      write(wfname, '(a)')  '/export9/radiosonde/rusa/osan24_500/add_data/st/tstprtminabs.nc'
      call out1d(trim(wfname), 'TPRTMIN', tprtmin, 'TIME', nday, day, trim(title))

      write(title,  '(a)')  'UPRTMAX'
      write(wfname, '(a)')  '/export9/radiosonde/rusa/osan24_500/add_data/st/ustprtmaxabs.nc'
      call out1d(trim(wfname), 'UPRTMAX', uprtmax, 'TIME', nday, day, trim(title))
    
      write(title,  '(a)')  'UPRTMIN'
      write(wfname, '(a)')  '/export9/radiosonde/rusa/osan24_500/add_data/st/ustprtminabs.nc'
      call out1d(trim(wfname), 'UPRTMIN', uprtmin, 'TIME', nday, day, trim(title))
    
      write(title,  '(a)')  'VPRTMAX'
      write(wfname, '(a)')  '/export9/radiosonde/rusa/osan24_500/add_data/st/vstprtmaxabs.nc'
      call out1d(trim(wfname), 'VPRTMAX', vprtmax, 'TIME', nday, day, trim(title))
    
      write(title,  '(a)')  'VPRTMIN'
      write(wfname, '(a)')  '/export9/radiosonde/rusa/osan24_500/add_data/st/vstprtminabs.nc'
      call out1d(trim(wfname), 'VPRTMIN', vprtmin, 'TIME', nday, day, trim(title))

      write(title,  '(a)')  'all TPRT'
      write(wfname, '(a)')  '/export9/radiosonde/rusa/osan24_500/add_data/st/tstprt0208.nc'
      call out2d(trim(wfname), 'TPRT', allt, 'TIME', nday, day,   &
                                'Z', nlev, Z, trim(title)              )
 
      write(title,  '(a)')  'all UPRT'
      write(wfname, '(a)')  '/export9/radiosonde/rusa/osan24_500/add_data/st/ustprt0208.nc'
      call out2d(trim(wfname), 'UPRT', allu, 'TIME', nday, day,   &
                                'Z', nlev, Z, trim(title)              )

      write(title,  '(a)')  'all VPRT'
      write(wfname, '(a)')  '/export9/radiosonde/rusa/osan24_500/add_data/st/vstprt0208.nc'
