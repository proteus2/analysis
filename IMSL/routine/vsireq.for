...
C-----------------------------------------------------------------------
C
      SUBROUTINE VSIREQ (A,IA,NR,NC,IOPT,NK,IR,WK,IER)
...
C                                    THE SORTED MATRIX.
   80 IT = 0
      ...
      DO 85 I=2,NR1
         IJ = NR1-I+2
         CALL VSCMPE(IOPT,KC,A(IJ-1,JCOLA),INKA,A(IJ,JCOLA),INKA,KOMPAR)
   ...
   90 IR(1) = -IR(1)
 9000 CONTINUE
      IF (IER.NE.0) CALL UERTST(IER,6HVSIREQ)
 9005 RETURN
      END
