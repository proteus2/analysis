...
C                             I=1,...,ND, J=1,...,ND.
C
C   REQD. IMSL ROUTINES - SINGLE/IQHSD,IQHSE,IQHSF,IQHSG,IQHSH,LLSQF,
C                           UERTST,UGETIO,VBLA=SASUM,VBLA=SDOT,
C                           VBLA=SNRM2,VHS12
C                         DOUBLE/IQHSD,IQHSE,IQHSF,IQHSG,IQHSH,LLSQF,
C                           UERTST,UGETIO,VBLA=DASUM,VBLA=DDOT,
C                           VBLA=DNRM2,VHS12
C
