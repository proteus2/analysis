...
C-----------------------------------------------------------------------
C
      SUBROUTINE VSIDA (A,IA,NR,NC,NK,WK,IER)
C                                  SPECIFICATIONS FOR ARGUMENTS
      INTEGER            IA,NR,NC,NK,IER
      DOUBLE PRECISION   A(IA,1),WK(1)
C                                  SPECIFICATIONS FOR LOCAL VARIABLES
      INTEGER            I,IJ,IL(21),INCA,INCJC,INCW,INKA,INKW,IR,IROW1,
...
C                                    THE UNSORTED MATRIX.
   ...
   75 CONTINUE
      ...
      GO TO 70
 9000 CONTINUE
      IF (IER.NE.0) CALL UERTST(IER,6HVSIDA )
 9005 RETURN
      END
