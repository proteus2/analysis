...
C-----------------------------------------------------------------------
C
      SUBROUTINE VSODAQ (A,IA,NR,NC,NK,IR,WK,IER)
...
C                                    THE SORTED MATRIX.
   80 IT = 0
      ...
      DO 85 I=2,NC
         IJ = NC-I+2
         CALL VDCMP(KR,A(IROWA,IJ-1),INKA,A(IROWA,IJ),INKA,KOMPAR)
   ...
   90 IR(1) = -IR(1)
 9000 CONTINUE
      IF (IER.NE.0) CALL UERTST(IER,6HVSODAQ)
 9005 RETURN
      END
