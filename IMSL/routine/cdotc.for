C   IMSL ROUTINE NAME   - VBLA=CDOTC
C
C-----------------------------------------------------------------------
C
...
C                           CONJUGATED VECTOR COMPONENTS
C
C   USAGE               - FUNCTION CDOTC (N,CX,INCX,CY,INCY)
C
C   ARGUMENTS    CDOTC  - COMPLEX SUM FROM I=1 TO N OF CONJ(X(I))*Y(I).
C                           (OUTPUT)
