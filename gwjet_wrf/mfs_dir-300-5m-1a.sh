...
while [ $K -le $K2 ] ; do
  ...
  if [ $iwave -eq 0 -o $iwave -eq -999 ] ; then
    P990[2]=$fidir/x${D}_5min/W_z/prt_d300km/fcoef_klo/fft_prt_W_klo__z${ZZZZZ}-1a.nc
    P990[3]=$fidir/x${D}_5min/U_z/prt_d300km/fcoef_klo/fft_prt_U_klo__z${ZZZZZ}-1a.nc
    P990[4]=$fidir/x${D}_5min/V_z/prt_d300km/fcoef_klo/fft_prt_V_klo__z${ZZZZZ}-1a.nc
    P999[2]=$ODIR/mfs_prt_phi_2d__z${ZZZZZ}-1a.nc
  fi
  [ -d $ODIR ] || mkdir -p $ODIR
