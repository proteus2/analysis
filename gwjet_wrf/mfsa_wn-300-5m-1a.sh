...
while [ $K -le $K2 ] ; do
  ...
  P990[2]=$fidir/x${D}_5min/W_z/prt_d300km/fcoef_kl/fft_prt_W_kl__z${ZZZZZ}-1a.nc
  P990[3]=$fidir/x${D}_5min/U_z/prt_d300km/fcoef_kl/fft_prt_U_kl__z${ZZZZZ}-1a.nc
  P990[4]=$fidir/x${D}_5min/V_z/prt_d300km/fcoef_kl/fft_prt_V_kl__z${ZZZZZ}-1a.nc
  ODIR=$fodir/x${D}_5min/mfs_z/prt_d300km
  P999[2]=$ODIR/mfsa_prt_wn__z${ZZZZZ}-w${iwave}.nc
  [ $iwave -eq 0 -o $iwave -eq -999 ] && P999[2]=$ODIR/mfsa_prt_wn__z${ZZZZZ}-1a.nc
  [ -d $ODIR ] || mkdir -p $ODIR
