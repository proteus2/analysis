...
P101=( s VAR_NAME  fc_${vars[$iv]}_r \
                   fc_${vars[$iv]}_i )
P102=( n NNN  721  1008  1 )    # Day 6.5-7.5 (D0 = 4)
...
P106=( n LAT_C  58. )           # central latitude for k ([/deg] to [/km])
#== Parameter 9 - I/O ============================
P990=( s FILE_I  '' )
P999=( s FILE_O  '' )
#=================================================
...
while [ $K -le $K2 ] ; do
  ...
  [ $iwave -eq 0 -o $iwave -eq -999 ] && P999[2]=$ODIR/fft_${vars[$iv]}_klo__z${ZZZZZ}-1a.nc
  [ -d $ODIR ] || mkdir -p $ODIR
