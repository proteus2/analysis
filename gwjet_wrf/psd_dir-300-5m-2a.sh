...
P110=( n WL_FILTER -999 )       # cut-off value of high-pass filter, integer [km]
#== Parameter 9 - I/O ============================
P990=( s FILE_I  '' )
P999=( s FILE_O  '' )
#=================================================
...
while [ $K -le $K2 ] ; do
  ...
  if [ $iwave -eq 0 -o $iwave -eq -999 ] ; then
    P990[2]=$fidir/x${D}_5min/${varsd[$iv]}_z/prt_d300km/fcoef_klo/fft_${vars[$iv]}_klo__z${ZZZZZ}-2a.nc
    P999[2]=$ODIR/psd_${vars[$iv]}_phi_2d__z${ZZZZZ}-2a
  fi
