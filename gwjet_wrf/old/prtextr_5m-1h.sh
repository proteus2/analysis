...
fotail="__08_00_00__12_00_00__1hrly.nc"
fodir="$DATD/gwjet_wrf"

#== Parameter 1 ==================================
P101=( s VAR_NAME  ${vars[$iv]} )
P102=( s GRID_I  ${vars[$iv]} )
P103=( n NNN  1  1153  12 )  # the first and last time indices and interval
...
while [ $K -le $K2 ] ; do
  ...
  ODIR=$fodir/x${D}_1hrly/prt_d300km
  P999[2]=$ODIR/prt_${vars[$iv]}__${fistrlev}${KKK}__x$D$fotail
  [ -d $ODIR ] || mkdir -p $ODIR
