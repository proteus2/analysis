...
D=$D1  ;  while [ $D -le $D2 ] ; do
  ...
  P990[2]=$fidir/x$D/prt_d300km/fcoef_klo/fft_prt_W_${levs[$il]}_klo.nc
  P990[3]=$fidir/x$D/prt_d300km/fcoef_klo/fft_prt_U_${levs[$il]}_klo.nc
  P990[4]=$fidir/x$D/prt_d300km/fcoef_klo/fft_prt_V_${levs[$il]}_klo.nc
  ODIR=$fodir/x$D/prt_d300km/mfs
  P999[2]=$ODIR/mfs_prt_${levs[$il]}_phi_2d.nc
  [ -d $ODIR ] || mkdir -p $ODIR
