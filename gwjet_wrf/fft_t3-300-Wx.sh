...
P104=( n L_RNG  0  647 )        # the first and last meridional wavenumber
#== Parameter 9 - I/O ============================
P990=( s FILE_I  '' )
P999=( s FILE_O  '' )
#=================================================
...
D=$D1  ;  while [ $D -le $D2 ] ; do
  ...
  P990[2]=$fidir/x$D/prt_d300km/fcoef_kl/fft-W${ww}_${vars[$iv]}_${levs[$il]}_kl.nc
  ODIR=$fodir/x$D/prt_d300km/fcoef_klo
  P999[2]=$ODIR/fft-W${ww}_${vars[$iv]}_${levs[$il]}_klo.nc
  [ -d $ODIR ] || mkdir -p $ODIR
