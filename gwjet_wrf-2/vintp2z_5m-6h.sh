...
EXTCTL2=17       ### CONTROLLED FOR SPLITTING - 2
NC1=$EXTCTL1
NC2=$EXTCTL2
vars=( U  V  W  P  T )
vars_f=( U  V  W  PRS  T )
...
fotail="__08_00_00__12_00_00__6hrly.nc"
...
while [ $NC -le $NC2 ] ; do
  ...
  P103[2]=$(( ( ( NC - 1 ) * ni ) + n0 ))
  P990[2]=$fidir/x${D}_1hrly/${vars_f[$iv]}/${vars_f[$iv]}__${fistrlev}
  P991[2]=__x$D$fitail
  P992[2]=$fidir/x${D}_1hrly/GEOP/GEOP__${fzstrlev}
  P993[2]=__x$D$fitail
  P994[2]=$fidir/x${D}_1hrly/domain_x$D.nc
  ODIR=$fodir/x${D}_6hrly/${vars_f[$iv]}_z
  P998[2]=$ODIR/${vars_f[$iv]}__${fostrlev}
  P999[2]=__x$D$fotail"-$NC4"
  [ -d $ODIR ] || mkdir -p $ODIR
